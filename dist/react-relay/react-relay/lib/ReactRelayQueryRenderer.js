...
var requestCache = {};
var STORE_AND_NETWORK = 'store-and-network';
/**
 * @public
 *
...
function fetchQueryAndComputeStateFromProps(props, queryFetcher, retryCallbacks, requestCacheKey) {
  ...
  if (query) {
    ...
    var relayContext = getContext(genericEnvironment, operation.request.variables);
    ...
    try {
      var storeSnapshot = props.fetchPolicy === STORE_AND_NETWORK ? queryFetcher.lookupInStore(genericEnvironment, operation) : null;
